...
public class GoToRefusalReferenceInDetailCommand implements Command {
    private static final Logger logger = LoggerFactory.getLogger(
            GoToRefusalReferenceInDetailCommand.class);
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            refusalReference = visitService.fetchDetailedRefusalReference(
                    referenceId, user);
        ...
        req.getRequestDispatcher(CommandPath.REFUSAL_REFERENCE_IN_DETAIL_JSP)
                .forward(req, res);
