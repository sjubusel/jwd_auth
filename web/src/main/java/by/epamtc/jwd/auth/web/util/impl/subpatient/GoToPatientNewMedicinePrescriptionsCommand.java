...
public class GoToPatientNewMedicinePrescriptionsCommand implements Command {
    private static final Logger logger = LoggerFactory.getLogger(
            GoToPatientNewMedicinePrescriptionsCommand.class);
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            prescriptions = patientService.fetchAllNewMedicinePrescriptions(user);
        ...
        req.getRequestDispatcher(CommandPath.SUBPATIENT_NEW_MED_PRESCR_JSP)
                .forward(req, res);
    }
}
