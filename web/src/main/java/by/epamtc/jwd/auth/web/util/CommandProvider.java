...
import by.epamtc.jwd.auth.web.util.impl.subpatient.GoToPatientRefusalReferenceInDetailCommand;
...
import by.epamtc.jwd.auth.web.util.impl.substaff.FormRefusalReferenceCancelCommand;
import by.epamtc.jwd.auth.web.util.impl.substaff.GoToAllRefusalReferencesCommand;
import by.epamtc.jwd.auth.web.util.impl.substaff.GoToDetailExecutePrescriptionByItsIdCommand;
...
import by.epamtc.jwd.auth.web.util.impl.substaff.RefusalMedicineRecommendationCancelCommand;
...
import by.epamtc.jwd.auth.web.util.impl.substaff.StaffExecuteNonMedicinePrescriptionCommand;
...
public class CommandProvider {
    ...
    private CommandProvider() {
        ...
        repository.put(CommandName.SUBSTAFF_GO_TO_EXECUTE_PRESCR_BY_ITS_ID,
                new GoToExecutePrescriptionByItsIdCommand());
        repository.put(CommandName.SUBSTAFF_GO_TO_DETAIL_EXECUTE_PRESCR_BY_ID,
        ...
        repository.put(CommandName.SUBPATIENT_DISAGREE_WITH_MEDICINE_PRESCRIPTION,
                new PatientDisagreeWithMedicinePrescriptionCommand());
        repository.put(CommandName.SUBPATIENT_GO_TO_NEW_PRESCRIPTIONS,
                new GoToPatientNewPrescriptionsCommand());
        repository.put(CommandName.SUBPATIENT_PATIENT_DISAGREE_WITH_PRESCRIPTION,
                new PatientDisagreeWithPrescriptionCommand());
        repository.put(CommandName.SUBSTAFF_GO_TO_MAKE_VISIT_DECISION,
                new GoToMakeVisitDecisionCommand());
        repository.put(CommandName.SUBSTAFF_GO_TO_REFUSE_TO_HOSPITALIZE,
                new GoToRefuseToHospitalizeCommand());
        repository.put(CommandName.SUBSTAFF_REFUSE_TO_HOSPITALIZE,
        ...
        repository.put(CommandName.SUBSTAFF_CANCEL_REFUSAL_MED_RECOMMENDATION,
                new RefusalMedicineRecommendationCancelCommand());
        repository.put(CommandName.SUBSTAFF_FORM_REFUSAL_REFERENCE,
        ...
        repository.put(CommandName.GO_TO_PATIENT_REFUSAL_REFERENCE_IN_DETAIL,
                new GoToPatientRefusalReferenceInDetailCommand());
