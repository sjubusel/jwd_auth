...
public final class CommandPath {
    ...
    public static final String SUBSTAFF_STAFF_ACCEPT_NON_MED_PRESCR_RESULT_TECH_ERROR
            = "/profile?command=go-to-staff-new-non-medicine-prescriptions" +
            "&acceptResult=techError";
    public static final String SUBSTAFF_STAFF_ACCEPT_NON_MED_PRESCR_RESULT_VAL_ERROR
            = "/profile?command=go-to-staff-new-non-medicine-prescriptions" +
            "&acceptResult=validationError";
    ...
    public static final String SUBPATIENT_GO_TO_NEW_MED_PRESCR_DISAGREE_RESULT_VAL_ERROR
            = "/profile?command=go-to-patient-new-medicine-prescriptions" +
    ...
    public static final String
            ...
            "&addResult=validationError&hiddenVisitId=";
    public static final String
            SUBSTAFF_GO_TO_REFUSE_TO_HOSPITALIZE_ADD_RESULT_TECH_ERROR
            = "/profile?command=go-to-refuse-to-hospitalize" +
            "&addResult=techError&hiddenVisitId=";
    public static final String
    ...
    public static final String
            ...
            = "/profile?command=go-to-refuse-to-hospitalize" +
            "&formResult=techError&hiddenVisitId=";
    public static final String
    ...
    public static final String SUBPATIENT_REFUSAL_REFERENCES_JSP
            = "/WEB-INF/jsp/patient/refusalReferencesForPatient.jsp";
    public static final String SUBPATIENT_REFUSAL_REFERENCE_IN_DETAIL_JSP
            = "/WEB-INF/jsp/patient/refusalReferenceInDetailForPatient.jsp";
